...
**Thriving Families Pillar Research Corpus**
...
Example: `A6_problem_landscape_child_care_access.md`
...
section: A
problem_statement: youth-employment | maternal-health | general
tags:
  - keyword1
  - keyword2
  - keyword3
...
key_entities:
  - Entity Name (e.g., Youth Works RVA, VDH, GRTC)
datasets:
  - Dataset name if mentioned
geography: Richmond, VA
date_generated: YYYY-MM-DD
source: parallel-ai | manual | other
...
```json
{
  "id": "A6_problem_landscape_child_care_access",
  "section": "A",
  "title": "Problem Landscape: Child Care Access Barriers",
...
Add a row to the appropriate section in the INDEX file:

```markdown
- [`A6_problem_landscape_child_care_access.md`](A6_problem_landscape_child_care_access.md) — Short description matching the report title
```
...
```json
{
  "id": "research/A6_problem_landscape_child_care_access",
  "path": "research/A6_problem_landscape_child_care_access.md",
  "type": "research_report",
  "title": "Problem Landscape: Child Care Access Barriers",
  "pillar": "thriving-families",
  "section": "A",
  "summary": "One to two sentence grounded summary.",
  "tags": ["child care", "access barriers", "families"],
  "recommended_audience": ["teams exploring family support solutions", "teams researching access barriers"],
  "read_after": ["research/A1_problem_landscape_youth_employment.md"],
...
`evidence_log.md` (root) tracks verified factual claims.

When you verify a new claim:
1. Add an entry under the appropriate status section (Confirmed, Likely but Unverified, Missing)
2. Include: claim description, official source URL, access date, status
3. If a claim was previously "Likely" and is now "Confirmed", move it to the Confirmed section with a note
4. If a claim is found to be incorrect, add a correction note rather than deleting it
...
The index.json should contain one entry per research `.md` file (excluding INDEX.md and README.md). To regenerate:
