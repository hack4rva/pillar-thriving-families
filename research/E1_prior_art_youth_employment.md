...
* **Early exposure improves persistence:** Integrating grades 9-14 career pathways ensures students are prepared for the workforce before they even apply for a summer job [4].
...
Tested city portals and Department of Labor content already exist; the primary constraint is orchestration and local adaptation, not novel R&D. By observing the successes and failures of established programs like Detroit's Grow Detroit's Young Talent (GDYT) [5] and national frameworks like Pathways to Prosperity [6], Richmond can bypass the costly trial-and-error phase of civic tech development.
...
| :--- | :--- | :--- | :--- | :--- |
| **CareerOneStop / GetMyFuture** | Career exploration, assessments, and training discovery for youth. | U.S. Department of Labor | O*NET web services, BLS data, state/local LMI [1] [2]. | Mobile-responsive, site-wide translation, interest assessments, saved profiles [7]. |
| **Detroit GDYT** | Summer youth employment application and provider management for ages 14-24 [5]. | Cityspan / YouthServices.net [8] | Participant applications, provider communications, exit surveys. | Centralized application portal, provider-specific document sharing. |
| **Pathways to Prosperity (PtoP)** | Grades 9-14 career pathways connecting high schools, colleges, and employers [4]. | Jobs for the Future (JFF) / Harvard Graduate School of Education [4]. | Regional labor market asset mapping, real-time job data. | Work-based learning, paid internships, dual enrollment, early college STEM schools [4]. |
| **NYC SYEP (YEPS Suite)** | Public application, participant portal, worksite portal, and service discovery. | NYC DYCD / YEPS Online [9] | Eligibility docs (ID, age, income), timesheets, provider data. | Multi-portal system, document upload, role-based dashboards. |
| **Boston SuccessLink** | Centralized youth job application, preference capture, and matching. | City of Boston / iCIMS [10] | Youth-entered data, eligibility docs, match rules. | Preference-based matching, onboarding support. |
...
* **Embedded Labor Data:** Utilizing O*NET and BLS web services ensures career information is accurate and up-to-date without manual intervention [1].
* **Sector-Specific Intermediaries:** Pathways to Prosperity's success relies heavily on intermediaries brokering relationships in IT, healthcare, and manufacturing [3].
...
* **Multilingual Support:** Ensure translation services are baked into the platform from day one, similar to CareerOneStop's language assistance features.
* **Document Checklists:** Provide clear, visual checklists with photo capture capabilities for uploading IDs and working papers.

### Back-end patterns

* **Role-based provider portals:** Worksites need dedicated interfaces to manage slots, approve timesheets, and submit evaluations.
* **API-level integrations:** Connect directly to O*NET for career content [1] and integrate with local banking partners for direct deposit onboarding.
...
| :--- | :--- | :--- | :--- |
| **Single youth "front door"** | Boston SuccessLink, Detroit GDYT | Fragmented (relies on basic rva.gov webforms) [11] | Higher abandonment due to confusing entry points. |
| **Role-based provider portal** | NYC worksite portal, GDYT Provider Portal | Manual (employer registration via ChamberRVA links) [12] | Inconsistent quality, heavy administrative burden. |
| **Embedded labor exploration** | CareerOneStop APIs [1] | Likely absent | Weak career fit, lower persistence in placements. |
| **Sector intermediaries** | Pathways to Prosperity (JFF) [6] | Partial (Office of Community Wealth Building and ChamberRVA) [12] [13] | Fewer worksites, employer fatigue. |
...
* **Target High-Growth Sectors:** Following the Pathways to Prosperity model, launch pilots in healthcare, IT, and advanced manufacturing, utilizing employer playbooks to standardize the experience.
...
* Embed CareerOneStop/O*NET exploration widgets to provide immediate value [1].
...
* **API Integrations:** Leverage O*NET/BLS for content [1], SMS gateways for communication, and secure banking APIs for payroll.
...
* **Employer Churn:** Mitigate by utilizing a dedicated intermediary to manage relationships and provide sector-specific playbooks.
...
* *Unknown:* While Richmond's application front-end relies on standard rva.gov forms and ChamberRVA links [11] [12], internal payroll/banking partners and specific data-sharing MOUs with Richmond Public Schools remain publicly undocumented. Additionally, specific SMS platforms used in peer cities like Boston and NYC are not publicly specified, though Boston's SuccessLink is known to utilize iCIMS [10] and NYC SYEP utilizes direct deposit to any bank or a payroll card [14] [15].
...
4. *Pathways to Prosperity Network*. https://jfforg-prod-new.s3.amazonaws.com/media/documents/Pathways_Membership.pdf
5. *Grow Detroit's Young Talent |*. https://www.gdyt.org/
6. *Pathways to Prosperity*. https://www.jff.org/idea/pathways-to-prosperity-network/
7. *Self Assessments | CareerOnestop*. https://www.careeronestop.org/ExploreCareers/Assessments/self-assessments.aspx
8. *Cityspan / YouthServices.net Staging Server Frameless*. https://www.youthservices.net/web/sms/login.asp
9. *YEPS Participant Site*. https://participant.yepsonline.org/
10. *BCYF Youth Engagement & Employment | Boston.gov | City of ...*. https://successlink-boston.icims.com/
11. *Youth Works RVA Application 26' | Richmond*. https://www.rva.gov/form/youth-works-rva-application-26
12. *Mayor's Youth Academy - Summer Work-Based Learning*. https://www.chamberrva.com/mayors-youth-academy-summer-work-based-learning/
13. *Youth Engagement Services | Richmond*. https://rva.gov/community-wealth-building/youth-engagement-services
14. *Summer Youth Employment Program (SYEP)*. https://www.yepsonline.org/images/Documents/SYEP%20Direct%20Deposit%20Manual.pdf
15. *SYEP 2025 Older Youth - Frequently Asked Questions*. https://application.nycsyep.com/Images/SYEP_2025_Participant_FAQ_OY.pdf