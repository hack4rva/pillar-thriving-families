...
Legal and document steps are not packaged in a single, authoritative place for families. Virginia law requires all 14- and 15-year-old workers to obtain an Employment Certificate via the Virginia Electronic Employment Certificate System (VAeECS) before beginning work. Minors are restricted to 3 hours on a school day (18 hours per school week) and 8 hours on a non-school day, and are prohibited from hazardous occupations [14]. However, this process implies a massive discoverability gap for teens trying to gather their I-9 documents, SSNs, and state permits in one unified flow.
...
| **VDH HealthStats** | City/County | 2006 to 2020 (ceiling 2020 — historical only; corrected 2026-03-18) | Infant deaths by race | Static tables (legacy) |
...
* **Locality-Level Outcomes:** Available via VDH HealthStats (2006 to 2020) [10] and CDC WONDER (since 1995) [11].
...
**Resolved unknowns from this pass:**
* **Virginia minors' work permit requirements:** Fully documented by DOLI; 14- and 15-year-olds require an Employment Certificate via VAeECS, are limited to 3 hours on school days, and are barred from hazardous occupations [14].
* **Active Richmond WIOA Youth providers:** Virginia Career Works Capital Region and the Capital Region Workforce Partnership provide services for disconnected youth ages 14-24 [15] [16].
* **Richmond teen programs beyond PFF:** The Mayor's Youth Academy (Youth Works RVA) offers an 8-week summer work-based learning program for ages 14-24, including transit support [17].

**Remaining Unknowns:**
* Richmond-specific maternal disparities beyond PRAMS dashboards (e.g., race/ethnicity cross-tabs within RCHD) require formal data requests.
...
1. How can the MVP best integrate the Virginia DOLI VAeECS employment certificate portal to streamline the application process for 14- and 15-year-olds?
2. What are the exact service inventories and intake APIs for WIOA Youth providers like the Capital Region Workforce Partnership?
...
* Virginia DOLI: [14]
* Virginia Career Works & CRWP: [15] [16]
* Youth Works RVA: [17]
...
14. *Youth Employment - DOLI - Virginia Department of Labor and Industry*. https://doli.virginia.gov/programs/labor-law/youth-employment/
15. *Youth Programs - Virginia Career Works*. https://virginiacareerworks.com/youth-programs/
16. *Capital Region Workforce Partnership*. https://henrico.gov/pdfs/finance/ApprovedBudgetFY25/80%20DEPT%2027%20-%20CRWP%20-%20FY25.pdf
17. *Youth Works RVA Application 26' | Richmond*. https://www.rva.gov/form/youth-works-rva-application-26