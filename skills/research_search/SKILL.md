...
description: Use when answering questions that require facts, evidence, personas, data sources, risks, or prior art from the Thriving Families pillar research corpus. Use when a team asks about Richmond youth employment, maternal health data coordination, services, data availability, MVP feasibility, demo strategy, or risks — before answering from memory.
---
...
Cite the source file when stating facts (e.g., "per A1_problem_landscape_youth_employment").
