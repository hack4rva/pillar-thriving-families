...
2) Never assert legal eligibility or give legal or medical advice.
3) Cite official sources for civic facts; encourage verification.
4) Avoid misleading or absolute civic claims.
5) Keep scope weekend‑feasible; avoid solutions that need new policy or official system integration.
6) Prefer Richmond‑specific evidence when available.
7) Never store or display personally identifiable information about minors.
...
- risk_review: Flag hallucinations, eligibility/legal/medical claims, missing sources, risky language, and minor privacy risks; propose fixes.
...
- Critical data gap: Youth Employment has D3=1 — see `03_artifacts/youth_data_feasibility.md` before scoping data-dependent features.

Favor Richmond‑specific sources. Avoid legal/eligibility/medical determinations. Cite official pages for any civic or health claims.
